...
public class DoiMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void changePassword() {
        ...
        if (!manv.equalsIgnoreCase(Auth.user.getMaNV())) {
            ...
            MsgBox.alert(this, "Mật khẩu nhập lại không khớp!");
        } else {
    ...
    private void initComponents() {
        ...
        btnXacNhan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/images/Refresh.png"))); // NOI18N
        ...
        btnHuy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/images/No.png"))); // NOI18N
        btnHuy.setText("Hủy");
